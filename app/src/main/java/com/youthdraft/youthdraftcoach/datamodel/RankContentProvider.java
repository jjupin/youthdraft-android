...
public class RankContentProvider extends ContentProvider {
    private static final String LOG_TAG = "RankContentProvider";

    private RankDBHelper mDbHelper;

    private static final int ALL_STORMS = 1;
    private static final int SINGLE_STORM = 2;

    private static final String AUTHORITY = "com.youthdraft.youthdraftcoach.rankcontentprovider";
    ...
    static {
        ...
        uriMatcher.addURI(AUTHORITY, "rank", ALL_STORMS);
        uriMatcher.addURI(AUTHORITY, "rank/#", SINGLE_STORM);
    }

    @Override
    public boolean onCreate() {
        mDbHelper = new RankDBHelper(getContext());
        return false;
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatcher.match(uri)) {
            case ALL_STORMS:
                return "vnd.android.cursor.dir/vnd.com.youthdraft.youthdraftcoach.rankcontentprovider.ranklist";
            case SINGLE_STORM:
                return "vnd.android.cursor.item/vnd.com.youthdraft.youthdraftcoach.rankcontentprovider.ranklist";
            default:
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long id = dbi.insert(RankDB.DATABASE_TABLE, null, values);
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        queryBuilder.setTables(RankDB.DATABASE_TABLE);
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case SINGLE_STORM:
                ...
                Log.d("FCP", "ID = " + id);
                queryBuilder.appendWhere(RankDB.KEY_ROWID + "=" + id); //+ id
                break;
            default:
                throw new IllegalArgumentException("Unsupported URI: " + uri);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        int deleteCount = dbd.delete(RankDB.DATABASE_TABLE, selection,
                selectionArgs);
        getContext().getContentResolver().notifyChange(uri, null);
        dbd.close();
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case SINGLE_STORM:
                String id = uri.getPathSegments().get(1);
                Log.d(LOG_TAG, "id =" + id);
                selection = RankDB.KEY_ROWID + "=" + id;
                break;
            default:
                throw new IllegalArgumentException("Unsupported URI: " + uri);
        }
        int updateCount = dbu.update(RankDB.DATABASE_TABLE, values,
